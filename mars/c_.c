...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_c_(const void *p[])
{
...
PyInit_c_(void)
{
  return _cffi_init("mars.c_", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initc_(void)
{
  _cffi_init("mars.c_", 0x2601, &_cffi_type_context);
}
#endif
